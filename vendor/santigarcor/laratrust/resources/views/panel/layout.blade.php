        ...
        <div class="flex items-center">
          <div class="hidden md:block">
            <div class="flex items-baseline" >
              <a href="{{config('laratrust.panel.go_back_route')}}" class="nav-button" style="color:#1A202C;">← Go Back</a>
              <a
                href="{{ route('laratrust.roles-assignment.index') }}" style="color:#1A202C;"
                class="ml-4 {{ request()->is('*roles-assigment*') ? 'nav-button-active' : 'nav-button' }}"
              >
                Roles & Permissions Assignment
              </a>
              <a
                href="{{route('laratrust.roles.index')}}" style="color:#1A202C;"
                class="ml-4 {{ request()->is('*roles') ? 'nav-button-active' : 'nav-button' }}"
              >
                Roles
              </a>
              <a
                href="{{ route('laratrust.permissions.index') }}" style="color:#1A202C;"
                class="ml-4 {{ request()->is('*permissions*') ? 'nav-button-active' : 'nav-button' }}"
              >
                Permissions
              </a>
              <a
                href="{{route('users.index')}}" style="color:#1A202C;"
                class="ml-4 {{ request()->is('*permissions*') ? 'nav-button-active' : 'nav-button' }}"
              >
                Users
              </a>
              <a
                href="{{route('courses.index')}}" style="color:#1A202C;"
                class="ml-4 {{ request()->is('*permissions*') ? 'nav-button-active' : 'nav-button' }}"
              >
                Courses
              </a>
